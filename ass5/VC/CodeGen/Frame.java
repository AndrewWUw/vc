...
public class Frame {
	...
	// Stacks for storing labels used for translating continue and break in
	// while
	...
	public int getNewIndex() {
		if (localVarIndex >= JVM.MAX_LOCALVARINDEX) {
			System.out.println("The maximum local variable index ("
	...
	public void push(int i) {
		...
		if (currentStackSize < 0 || currentStackSize > JVM.MAX_OPSTACK) {
			...
			System.out.println("Current operand stack size is "
					+ currentStackSize + ".");
			System.out.println("You wanted to push " + i
